...
class Grain extends SandGrain {
  ...
  profile(name) {
    ...
    return this._profiler.profiler(name);
  }

  get enabled() {
    return this.config.enabled || (sand.context && (sand.context.queryInt('sand.profiler.enable') || false));
  }
}
